...
- Construindo projetos com **Node.js**, **Java**, **Python**, **SQL**, **Express**, **Prisma**, **JWT**, **Git** e **GitHub**
...
## Trilha de evolução back-end

| Etapa | Repositório | O que demonstra |
|---|---|---|
| 1 | [consultas-sql-biblioteca](https://github.com/GustavoZanc/consultas-sql-biblioteca) | Base de banco de dados, tabelas, joins, filtros e consultas |
| 2 | [controle-tarefas-python](https://github.com/GustavoZanc/controle-tarefas-python) | API REST iniciante com Node.js, CRUD e persistência em JSON |
| 3 | [python-calculadora-imc](https://github.com/GustavoZanc/python-calculadora-imc) | API HTTP iniciante com Java, validação e resposta em JSON |
| 4 | [python-organizador-arquivos](https://github.com/GustavoZanc/python-organizador-arquivos) | Automação de arquivos e scripts úteis para rotina back-end |
| 5 | [project-py-personal](https://github.com/GustavoZanc/project-py-personal) | Estudos práticos e evolução em lógica de programação |
...
Node.js -> Java -> API REST -> regras de negócio -> autenticação -> banco de dados -> documentação
```
